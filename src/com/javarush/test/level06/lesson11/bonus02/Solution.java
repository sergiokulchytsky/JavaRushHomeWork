...
Создать класс, который бы описывал данную ситуацию. Создать два объекта: кошку-дочь и кошку-маму. Вывести их на экран.
...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat catFather = new Cat(fatherName, catGFather);

        String motherName = reader.readLine();
        Cat catMother = new Cat(catGMother, motherName);
    ...
    public static class Cat
    {
        ...
        {
            return "Cat name is " + name + ", " + (mother == null ? "no mother" : "mother is " + mother.name) + ", "
